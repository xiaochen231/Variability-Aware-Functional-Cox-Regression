...
grid_y <- rep(c(rep("r = 0.3", 300*length(censoringvalues_plot_all)*length(q_plot_all)*length(q_true_plot_all)), 
                rep("r = 0.5", 300*length(censoringvalues_plot_all)*length(q_plot_all)*length(q_true_plot_all)), 
                rep("r = 0.8", 300*length(censoringvalues_plot_all)*length(q_plot_all)*length(q_true_plot_all)))  ,
              length(n1_plot_all))
