...
grid_x <- c(rep("Censoring = 10%", 300*length(n1_plot_all)*length(rho_plot_all)*length(q_plot_all)*length(q_true_plot_all)),  
            rep("Censoring = 20%", 300*length(n1_plot_all)*length(rho_plot_all)*length(q_plot_all)*length(q_true_plot_all)), 
            rep("Censoring = 30%", 300*length(n1_plot_all)*length(rho_plot_all)*length(q_plot_all)*length(q_true_plot_all)),  
            rep("Censoring = 50%", 300*length(n1_plot_all)*length(rho_plot_all)*length(q_plot_all)*length(q_true_plot_all)))  
grid_x <- factor(grid_x, levels = c(  "Censoring = 10%", "Censoring = 20%",  "Censoring = 30%",  "Censoring = 50%"))



grid_y <- rep(c(rep("r = 0.3", 300*length(n1_plot_all)*length(q_plot_all)*length(q_true_plot_all)), 
                rep("r = 0.5", 300*length(n1_plot_all)*length(q_plot_all)*length(q_true_plot_all)), 
                rep("r = 0.8", 300*length(n1_plot_all)*length(q_plot_all)*length(q_true_plot_all)))  ,
